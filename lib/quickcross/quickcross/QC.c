...
/**********************************************
 * The Print_Help() function ist commented out
 * because it is only used by main, which is
 * deactivated because QuickCross is used as a
 * library in mockturtle.
 ***********************************************/
...
/**********************************************
* The main() function ist commented out because
* QuickCross is used as a library in mockturtle.
***********************************************/
